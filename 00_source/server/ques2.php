...
if($sql_result = mysqli_query($link,$sql)){
    while($row = mysqli_fetch_assoc($sql_result)){
        array_push($choices,array($row['ansText1'],$row['ansText3'],$row['ansText3'],$row['ansText4'],));
        array_push($corrects,array($row['correctText1'],$row['correctText3'],$row['correctText3'],$row['correctText4'],));
...
$b = json_encode(array($quesArray,'result' => $result, 'resultdesc' => $resultDesc,));
